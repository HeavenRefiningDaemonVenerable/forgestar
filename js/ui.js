...
export function updateStats() {
    ...
    const starShardsEl = document.querySelector('[data-stat="starShards"]');
    if (starShardsEl) {
        starShardsEl.textContent = `${formatNumber(game.starShards)} (+${formatNumber(game.starShardsPerSecond)}/s)`;
    }
    ...
    app.innerHTML = `
        ...
        <div class="utility-bar">
              ...
              <div class="stats-panel">
                  ...
                  <div class="stat-row">
                      <span class="stat-label">Star Shards:</span>
                      <span class="stat-value" data-stat="starShards">${formatNumber(game.starShards)} (+${formatNumber(game.starShardsPerSecond)}/s)</span>
                  </div>
                  <div class="stat-row">
              ...
              <div class="forge-section">
                <div class="menu-background">
                  ...
                  <button class="forge-button" data-action="clickForge">
                     ...
                     <img src="https://dl.dropbox.com/scl/fi/qd5kihwbd5ncogx7mau09/1000089697.png?rlkey=c8pe0m3w84g0s2pnau37huxgi&st=pj0k5unt&dl=0" alt="Forge Star" class="forge-star-image">
                  </button>
              </div>
